    ...
    >
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="glass fixed z-[101] rounded-2xl border border-white/10 p-5 shadow-2xl shadow-black/40"
          style={cardStyle(rect, currentStep.placement ?? 'bottom')}
        >
          <div className="flex items-start justify-between gap-3">
            ...
            <button
              ...
              className="-mr-1 -mt-1 rounded-lg p-1 text-slate-400 transition hover:bg-white/10 hover:text-slate-200"
            >
              <X className="h-4 w-4" />
            </button>
          </div>
          ...
          <div className="mt-4 flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                type="button"
                onClick={next}
                className="inline-flex items-center gap-1 rounded-full bg-gradient-to-r from-brand-500 to-fuchsia-500 px-4 py-1.5 text-xs font-semibold text-white shadow-lg shadow-brand-500/30 transition hover:opacity-90"
              >
                {isLast ? 'Done' : 'Next'}
